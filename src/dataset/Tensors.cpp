...
///////////////////////////////////////////////////////////////////////////
void Tensors::setTensorInfo( FTensor i_FTensor, vector< FMatrix > &o_matrixVector, vector< float > &o_FAVector )
{
    ...
    o_FAVector.push_back( Helper::getFAFromEigenValues( l_eigenValues[0], l_eigenValues[1], l_eigenValues[2] ) );
...
{
    // To quite down the compiler warning, this param is not used for the tensor.
