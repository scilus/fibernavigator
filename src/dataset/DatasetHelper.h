...
public:
	...
	std::vector< std::vector< SelectionObject* > > getSelectionObjects();
	...
	void toggleSelectionObjects() { m_showObjects = ! m_showObjects; };
	...
	bool  m_displayFibersInfo;
    bool  m_displayMeanFiber;
