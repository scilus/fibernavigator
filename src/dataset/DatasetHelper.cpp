...
bool DatasetHelper::load( const int i_index )
{
    ...
    wxString l_wildcard         = wxT( "*.*|*.*|Nifti (*.nii*)|*.nii*|Mesh files (*.mesh)|*.mesh|Mesh files (*.surf)|*.surf|Mesh files (*.dip)|*.dip|Fibers VTK (*.fib)|*.fib|Fibers PTK (*.bundlesdata)|*.bundlesdata|Scene Files (*.scn)|*.scn|Tensor files (*.nii*)|*.nii*|ODF files (*.nii*)|*.nii*" );
