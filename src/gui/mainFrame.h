...
private:
	...
	// sampling
	void OnSetSampling1                     ( wxCommandEvent& event );
	void OnSetSampling2                     ( wxCommandEvent& event );
	void OnSetSampling3                     ( wxCommandEvent& event );
	void OnSetSampling4                     ( wxCommandEvent& event );
	void OnSetSampling5                     ( wxCommandEvent& event );
	void OnSetSampling6                     ( wxCommandEvent& event );
	void OnSetSamplingNo                     ( wxCommandEvent& event );
	// Help
    ...
    void OnSaveFibersDMRI( wxCommandEvent& WXUNUSED(event) );
    /*
     * System functions
     */
...
public:
    ...
    MySlider*           m_tSlider;
    wxSlider*           m_tSlider2;
	wxSlider*			m_sliderFibersFilterMin;
	wxSlider*			m_sliderFibersFilterMax;
	wxSlider*			m_sliderFibersSampling;
	
	wxStaticText*		m_textFibersFilter;
	wxStaticText*		m_textFibersSampling;
	wxTextCtrl*			m_rulerDisplay;	
...
#define MENU_FILE_SAVE_FIBERS_DMRI                  110
...
#define MENU_VOI_SET_AS_DISTANCE_ANCHOR             153
#define MENU_VOI_FLIP_NORMALS                       154
...
#define MENU_SURFACE_NEW_OFFSET						176
#define MENU_SURFACE_DIST_MAP                       180
// Menu Options
...
#define MENU_OPTIONS_RULER_TOOL						201
#define MENU_OPTIONS_RULER_TOOL_CLEAR				202
#define MENU_OPTIONS_RULER_TOOL_DEL					203
#define MENU_OPTIONS_RULER_TOOL_ADD					204

#define MENU_OPTIONS_SAMPLING						210
#define MENU_OPTIONS_SAMPLING_OPT1					211
#define MENU_OPTIONS_SAMPLING_OPT2					212
#define MENU_OPTIONS_SAMPLING_OPT3					213
#define MENU_OPTIONS_SAMPLING_OPT4					214
#define MENU_OPTIONS_SAMPLING_OPT5					215
#define MENU_OPTIONS_SAMPLING_OPT6					216
#define MENU_OPTIONS_SAMPLING_OPTNO					217
...
#define BUTTON_DISPLAY_DISPERSION_TUBE              250
...
#define MENU_LIST_COLOR_DISTANCE                    257
#define MENU_LIST_COLOR_MINDISTANCE                 258
#define MENU_LIST_COLOR_CURVATURE                   259
#define MENU_LIST_COLOR_TORSION                     260
#define MENU_LIST_GENERATE_FIBERVOLUME              261
#define MENU_LIST_CUTOUT                            265
/*
...
#define ID_FIBERS_FILTER_SLIDER1					327
#define ID_FIBERS_FILTER_SLIDER2					328
#define ID_FIBERS_FILTER_SLIDER_TEXT				329			
#define ID_FIBERS_SAMPLING_SLIDER_TEXT				330	
#define ID_FIBERS_SAMPLING_SLIDER					331	
#define ID_RULER_DISPLAY							332
#define ID_FIBERS_INFO_GRID							340

#define ID_BUTTON_UP 								349
