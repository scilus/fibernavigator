...
void SelectionObject::createPropertiesSizer(MainFrame *parent)
{
    ...
    m_propertiesSizer->Add(l_sizer,0,wxALIGN_CENTER);   
    parent->Connect(m_ptoggleVisibility->GetId(),wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnToggleShowSelectionObject));
    parent->Connect(m_ptoggleActivate->GetId(),wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxTreeEventHandler(MainFrame::OnActivateTreeItem));
    ...
    m_propertiesSizer->Add(l_sizer,0,wxALIGN_CENTER);
    parent->Connect(m_pbtnChangeName->GetId(),wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnRenameBox));
    parent->Connect(m_ptoggleAndNot->GetId(), wxEVT_COMMAND_TOGGLEBUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnToggleAndNot));
    ...
    parent->Connect(m_pbtnFlipNormal->GetId(), wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnVoiFlipNormals));
    parent->Connect(m_pbtnSelectColor->GetId(),wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnColorRoi));
    ...
    parent->Connect(m_pbtnNewFibersDensityVolume->GetId(),wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnCreateFibersDensityTexture));
    ...
    parent->Connect(m_pbtnSetAsDistanceAnchor->GetId(),wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnDistanceAnchorSet));
	...
	//l_sizer->Add(new wxStaticText(parent, wxID_ANY, wxT("Position"),wxDefaultPosition, wxSize(200,-1), wxALIGN_CENTER),0,wxALIGN_CENTER);
	...
	m_propertiesSizer->Add(l_sizer,0,wxALIGN_CENTER);
	parent->Connect(m_ctrlBoxX->GetId(),wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(MainFrame::OnBoxPositionX));
	parent->Connect(m_ctrlBoxY->GetId(),wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(MainFrame::OnBoxPositionY));
	parent->Connect(m_ctrlBoxZ->GetId(),wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(MainFrame::OnBoxPositionZ));

	l_sizer = new wxBoxSizer(wxHORIZONTAL);
	//l_sizer->Add(new wxStaticText(parent, wxID_ANY, wxT("Size"),wxDefaultPosition, wxSize(200,-1), wxALIGN_CENTER),0,wxALIGN_CENTER);
	m_ctrlBoxSizeX = new wxTextCtrl( parent, wxID_ANY, wxString::Format( wxT( "%.2f"), m_center.x), wxDefaultPosition, wxSize(45,-1));
	l_sizer->Add(new wxStaticText(parent, wxID_ANY, wxT("x: "),wxDefaultPosition, wxSize(15,-1), wxALIGN_CENTER),0,wxALIGN_CENTER);
	l_sizer->Add(m_ctrlBoxSizeX,0,wxALIGN_CENTER);
	
	
	m_ctrlBoxSizeY = new wxTextCtrl( parent, wxID_ANY, wxString::Format( wxT( "%.2f"), m_center.y), wxDefaultPosition, wxSize(45,-1));
	l_sizer->Add(new wxStaticText(parent, wxID_ANY, wxT("y: "),wxDefaultPosition, wxSize(15,-1), wxALIGN_CENTER),0,wxALIGN_CENTER);
	l_sizer->Add(m_ctrlBoxSizeY,0,wxALIGN_CENTER);


	m_ctrlBoxSizeZ = new wxTextCtrl( parent, wxID_ANY, wxString::Format( wxT( "%.2f"), m_center.z), wxDefaultPosition, wxSize(45,-1));
	l_sizer->Add(new wxStaticText(parent, wxID_ANY, wxT("z: "),wxDefaultPosition, wxSize(15,-1), wxALIGN_CENTER),0,wxALIGN_CENTER);
	l_sizer->Add(m_ctrlBoxSizeZ,0,wxALIGN_CENTER);

	m_propertiesSizer->Add(l_sizer,0,wxALIGN_CENTER);
	parent->Connect(m_ctrlBoxSizeX->GetId(),wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(MainFrame::OnBoxPositionX));
	parent->Connect(m_ctrlBoxSizeY->GetId(),wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(MainFrame::OnBoxPositionY));
	parent->Connect(m_ctrlBoxSizeZ->GetId(),wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler(MainFrame::OnBoxPositionZ));
...
void SelectionObject::updatePropertiesSizer()
{
	...
	if(m_boxMoved)
	{
		m_ctrlBoxX->SetValue(wxString::Format( wxT( "%.2f"), m_center.x));
		m_ctrlBoxY->SetValue(wxString::Format( wxT( "%.2f"), m_center.y));
		m_ctrlBoxZ->SetValue(wxString::Format( wxT( "%.2f"), m_center.z));
		m_boxMoved = false;
