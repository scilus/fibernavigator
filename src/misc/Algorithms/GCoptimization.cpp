...
bool GCoptimization::readyToOptimise()
{
    ...
    if (!m_datacostFn)
        ...
        //mexPrintf( "In readyToOptimise(), after second if...\n" );
    return(true);
