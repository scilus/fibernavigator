...
inline void Energy::add_constant(Value A) { m_Econst += (TotalValue)A; }
                              ...
                              Value E110, Value E111)
{
    ...
    if (pi >= 0)
    {
        m_Econst += (TotalValue)(E111 - (E011 + E101 + E110));
    ...
    {
        m_Econst += (TotalValue)(E000 - (E100 + E010 + E001));
...
inline Energy::TotalValue Energy::minimize() { return m_Econst + maxflow(); }
